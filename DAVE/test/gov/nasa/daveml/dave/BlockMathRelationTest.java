...
public class BlockMathRelationTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		_value1SignalID = new String("ALP_UNLIM");
		_value2SignalID = new String("ALP_LIMIT");
	...
	public final void testGetSetValidateUpdateRelation() {
        ...
        assertFalse( checkRelation(  4.5, "lt",  2.0, false ) ); assertEquals( "lt",  _block.getRelationOp() );
        assertFalse( checkRelation(  4.5, "leq", 2.0, false ) ); assertEquals( "leq", _block.getRelationOp() );
        assertFalse( checkRelation(  4.5, "eq",  2.0, false ) ); assertEquals( "eq",  _block.getRelationOp() );
        assertTrue(  checkRelation(  4.5, "geq", 2.0, false ) ); assertEquals( "geq", _block.getRelationOp() );
        assertTrue(  checkRelation(  4.5, "gt",  2.0, false ) ); assertEquals( "gt",  _block.getRelationOp() );

        assertTrue(  checkRelation( -4.5, "lt",  2.0, false ) ); assertEquals( "lt",  _block.getRelationOp() );
        assertTrue(  checkRelation( -4.5, "leq", 2.0, false ) ); assertEquals( "leq", _block.getRelationOp() );
        assertFalse( checkRelation( -4.5, "eq",  2.0, false ) ); assertEquals( "eq",  _block.getRelationOp() );
        assertFalse( checkRelation( -4.5, "geq", 2.0, false ) ); assertEquals( "geq", _block.getRelationOp() );
        assertFalse( checkRelation( -4.5, "gt",  2.0, false ) ); assertEquals( "gt",  _block.getRelationOp() );
        
        assertFalse( checkRelation(  2.0, "lt",  2.0, false ) ); assertEquals( "lt",  _block.getRelationOp() );
        assertTrue(  checkRelation(  2.0, "leq", 2.0, false ) ); assertEquals( "leq", _block.getRelationOp() );
        assertTrue(  checkRelation(  2.0, "eq",  2.0, false ) ); assertEquals( "eq",  _block.getRelationOp() );
        assertTrue(  checkRelation(  2.0, "geq", 2.0, false ) ); assertEquals( "geq", _block.getRelationOp() );
        assertFalse( checkRelation(  2.0, "gt",  2.0, false ) ); assertEquals( "gt",  _block.getRelationOp() );
