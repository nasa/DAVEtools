...
public class BlockMathAbsTest extends TestCase {
	...
	_writer  = new StringWriter();
		...
		try {
			...
			fail("Exception in TestBlockMathAbs.setUp(): " + e.getMessage() );
		}
    }
	...
	public void testDescribeSelf() {
		...
		assertEquals( "Block \"abs_1\" has one input (beta), NO OUTPUTS," +
	...
	public void testGetOutputVarID() {
		assertNull(_block.getOutputVarID() );
	}
