...
public class MatFileWriter extends FileWriter
{
    ...
    private int writeMatrix( String arrayName, ArrayList<Double> table, 
            int[] dims, int startIndex, String higherDims )
    throws IOException
    {
